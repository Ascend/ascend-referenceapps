...
class DistanceIVFInt8CosL1:
    ...
    def check_parameter(self):
        ...
        if self.code_num % 32 != 0:
            raise RuntimeError("code num must be a multiple of 32")
    ...
    def set_tik_instance(self):
        ...
        self.code_num_each_loop = min(min((48 // self.queries_num_each_loop) * 512, 1024), self.code_num // 2)
