...
#ifndef GE_OP_DISTANCECOMPUTE_FLAT_IP_MAXS_H
#define GE_OP_DISTANCECOMPUTE_FLAT_IP_MAXS_H

#include "graph/operator_reg.h"

namespace ge {
REG_OP(DistanceFlatIPMaxs)
    ...
    .OP_END_FACTORY_REG(DistanceFlatIPMaxs)
} // namespace ge

#endif // GE_OP_DISTANCECOMPUTE_FLAT_IP_MAXS_H