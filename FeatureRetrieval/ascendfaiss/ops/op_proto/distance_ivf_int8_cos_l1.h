...
#ifndef GE_OP_DISTANCE_IVF_INT8_COS_L1_H
#define GE_OP_DISTANCE_IVF_INT8_COS_L1_H

#include "graph/operator_reg.h"

namespace ge {
    REG_OP(DistanceIVFInt8CosL1)
        ...
        .OP_END_FACTORY_REG(DistanceIVFInt8CosL1)
} // namespace ge
#endif // GE_OP_DISTANCE_IVF_INT8_COS_L1_H