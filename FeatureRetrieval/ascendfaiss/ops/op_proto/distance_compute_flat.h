...
#ifndef GE_OP_DISTANCECOMPUTE_FLAT_H
#define GE_OP_DISTANCECOMPUTE_FLAT_H

#include "graph/operator_reg.h"

namespace ge {
REG_OP(DistanceComputeFlat)
    ...
    .OP_END_FACTORY_REG(DistanceComputeFlat)
} // namespace ge

#endif // GE_OP_DISTANCECOMPUTE_FLAT_H