...
#ifndef GE_OP_DISTANCECOMPUTE_FLAT_MIN64_H
#define GE_OP_DISTANCECOMPUTE_FLAT_MIN64_H

#include "graph/operator_reg.h"

namespace ge {
REG_OP(DistanceComputeFlatMin64)
    ...
    .OP_END_FACTORY_REG(DistanceComputeFlatMin64)
} // namespace ge

#endif // GE_OP_DISTANCECOMPUTE_FLAT_Min64_H