...
#include "distance_compute_sq8_min64.h"
#include <vector>
#include <string>
#include <iostream>

namespace ge {
    IMPLEMT_VERIFIER(DistanceComputeSQ8Min64, DistanceComputeSQ8Min64Verify)
    {
    ...
    IMPLEMT_COMMON_INFERFUNC(DistanceComputeSQ8Min64InferShape)
    {
    ...
    COMMON_INFER_FUNC_REG(DistanceComputeSQ8Min64, DistanceComputeSQ8Min64InferShape);

    // Registered verify function
    VERIFY_FUNC_REG(DistanceComputeSQ8Min64, DistanceComputeSQ8Min64Verify);
} // namespace ge