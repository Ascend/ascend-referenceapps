...
#ifndef GE_OP_DISTANCE_IVF_INT8_COS_H
#define GE_OP_DISTANCE_IVF_INT8_COS_H

#include "graph/operator_reg.h"

namespace ge {
    REG_OP(DistanceIVFInt8Cos)
        ...
        .OP_END_FACTORY_REG(DistanceIVFInt8Cos)
} // namespace ge
#endif // GE_OP_DISTANCE_IVF_INT8_COS_H