...
#ifndef GE_OP_DISTANCE_SQ8_IP_MAXS_H
#define GE_OP_DISTANCE_SQ8_IP_MAXS_H

#include "graph/operator_reg.h"

namespace ge {
    REG_OP(DistanceSQ8IPMaxs)
        ...
        .OP_END_FACTORY_REG(DistanceSQ8IPMaxs)
} // namespace ge
#endif // GE_OP_DISTANCE_SQ8_IP_MAXS_H