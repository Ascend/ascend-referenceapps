...
#include "distance_compute_flat.h"
#include <vector>
#include <string>
#include <iostream>

namespace ge {
IMPLEMT_VERIFIER(DistanceComputeFlat, DistanceComputeFlatVerify)
{
...
IMPLEMT_COMMON_INFERFUNC(DistanceComputeFlatInferShape)
{
...
COMMON_INFER_FUNC_REG(DistanceComputeFlat, DistanceComputeFlatInferShape);

// Registered verify function
VERIFY_FUNC_REG(DistanceComputeFlat, DistanceComputeFlatVerify);
} // namespace ge