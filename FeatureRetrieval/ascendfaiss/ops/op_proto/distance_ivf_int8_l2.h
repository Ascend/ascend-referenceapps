...
#ifndef GE_OP_DISTANCE_IVF_INT8_L2_H
#define GE_OP_DISTANCE_IVF_INT8_L2_H

#include "graph/operator_reg.h"

namespace ge {
REG_OP(DistanceIVFInt8L2)
    ...
    .OP_END_FACTORY_REG(DistanceIVFInt8L2)
} // namespace ge

#endif // GE_OP_DISTANCE_IVF_INT8_L2_H