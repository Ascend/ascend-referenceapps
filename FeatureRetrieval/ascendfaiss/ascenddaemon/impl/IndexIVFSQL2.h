...
#ifndef ASCEND_INDEXIVFSQ_L2_INCLUDED
#define ASCEND_INDEXIVFSQ_L2_INCLUDED
...
namespace ascend {
class IndexIVFSQL2 : public IndexIVFSQ<float> {
public:
    IndexIVFSQL2(int numList, int dim, bool encodeResidual, int nprobes, int resourceSize = -1);
...
#endif // ASCEND_INDEXIVFSQ_L2_INCLUDED
