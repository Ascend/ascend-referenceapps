...
#ifndef ASCEND_INDEX_INT8_FLAT_COS_INCLUDED
#define ASCEND_INDEX_INT8_FLAT_COS_INCLUDED
...
namespace ascend {
class IndexInt8FlatCos : public IndexInt8Flat<float16_t> {
public:
    using idx_t = Index::idx_t;

    IndexInt8FlatCos(int dim, int resourceSize = -1);
...
#endif // ASCEND_INDEX_INT8_FLAT_COS_INCLUDED
