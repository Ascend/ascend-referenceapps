...
#ifndef ASCEND_INDEXSQ_IP_INCLUDED
#define ASCEND_INDEXSQ_IP_INCLUDED
...
namespace ascend {
class IndexSQIP : public IndexSQ {
public:
    using idx_t = Index::idx_t;

    IndexSQIP(int dim, int resource = -1);
...
#endif // ASCEND_INDEXSQ_IP_INCLUDED
