...
class ImagePreprocess : public ascendBaseModule::ModuleBase {
public:
    ImagePreprocess();
    ~ImagePreprocess();
...
private:
    ...
    void FindTheBestHWSize(uint32_t &bestWidth, uint32_t &bestHight, uint32_t inWidth, uint32_t inHeight) const;
